...
{
	private var rgbshift:RGBShiftCont;
	/**
	...
	{
		rgbshift = new RGBShiftCont(FlxG.camera.buffer);
		stage.addChild(rgbshift);
		var i:Int = stage.getChildIndex(rgbshift);
		while (stage.numChildren > i + 1) {
	...
	private function draw():Void
	{
		if (rgbshift != null)
		{
			rgbshift.update(FlxG.camera.buffer);
		}
		...
		//stage.
		//var bmd:BitmapData = new BitmapData(320, 240, true, 0x00000000);
		//bmd.draw(stage);
		//
